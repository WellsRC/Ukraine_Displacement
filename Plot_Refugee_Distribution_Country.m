...
load('Refugee_Country_Distribution_Parameters.mat','lambda_sci','lambda_bc','sc_bc','s_nato','lambda_GDP');
...
Country_Name={'Russia','Poland','Belarus','Slovakia','Hungary','Romania','Moldova','Europe (Other)'};
