function [Total_Burden_Refugee,Total_Burden_UKR] = Disease_Burden_Displacement_Random_Sample(Displace_Pop,Pop_Male,Pop_Remain,Ukraine_Pop,sc_sci,lambda_bc,sc_bc,sc_nbc,ws,wo,Border_Crossing_Country)
