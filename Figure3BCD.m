...
T_HS=table(Shapefile_Raion_Oblast_Namet,Shapefile_Raion_Namet,Pop_Pre_Inv,Hosp_Raion(:,1),Est_Pop_NIDP.raion,Est_Daily_IDP.raion(:,end),Hosp_Raion(:,2),'VariableNames',{'Oblast','Raion','Population (Pre-Invasion)','Hospitals (Pre-Invasion','Non-IDP','IDP','Hospital inaccessible'});
save('MLE_Hospital_Table.mat','T_HS')
...
set(gca,'LineWidth',2,'tickdir','out','YTick',1:7,'YTickLabel',NMR,'Fontsize',24,'XTick',[-60:10:70]);
xlim([-60 70]);
box off;
