...
[Total_Burden_IDP] = Disease_Burden_Displacement_IDP(Pop_Non_IDP,Pop_Moving_R,Pop_Male_R,Pop_Total_R,Mapped_Raion_Name,Parameter_IDP,Pop_Raion_M(Raion_IDP>0,:),SCI_IDPt(Raion_IDP>0,:),Raion_Dist_BC(Raion_IDP>0,:),Num_BC(Raion_IDP>0),Raion_Conflict(Raion_IDP>0),DistC(Raion_IDP>0,:),Dist(Raion_IDP>0,:),Raion_Zone_R(Raion_IDP>0),Raion_Zone_Full);
save('Input_Figure3D.mat','Raion_Index','Total_Burden_IDP','Pop_Non_IDP','Pop_Male_R','Pop_Moving_R','Pop_Total_R','Mapped_Raion_Name','Parameter_IDP','Pop_Raion_M','SCI_IDPt','Raion_IDPSites','Raion_Dist_BC','Num_BC','Raion_Conflict','DistC','Dist','Raion_Zone_R','Raion_IDP','Raion_Zone_Full');
