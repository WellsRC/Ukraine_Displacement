function [Parameter_V,L_V,a_V] = MCMC_UKR_Origin(MCMC_Parameters,vLat_C,vLon_C,Lat_P,Lon_P,Pop_F_Age,Pop_M_Age,Pop_MACRO,Number_Displacement,Date_Displacement,RC,Time_Switch,Time_Sim,ML_Indx,day_W_fix)
...
Daily_IDP_Origin=squeeze(sum(Pop_IDP,[1 3]));

L_old = -ObjectiveFunction_IDP_Refugee(x_old,vLat_C,vLon_C,Lat_P,Lon_P,Pop_F_Age,Pop_M_Age,Pop_MACRO,Number_Displacement,Date_Displacement,RC,Time_Switch,Time_Sim,ML_Indx,day_W_fix);
